            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="table-responsive">
                        <table id="kategori-tokoh-datatables" class="table table-striped table-bordered">
                    ...
                    <div class="mt-4 text-center">
                        <div id="kategori-tokoh-datatables_paginate"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $('#kategori-tokoh-datatables').DataTable({
            processing: true,
            serverSide: true,
